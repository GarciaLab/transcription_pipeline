...
def preallocate_buffers(zarr_arr, window, weights, out, chunk_len, cp, init_block):
    ...
    if out is None:
        out = np.empty(zarr_arr.shape, dtype=np.float32)
...
if __name__ == "__main__":
    ...
    out_store = "/mnt/Data4/Yovan/sols_pipeline/test_destriped_time_filtered_channel_0.ome.zarr"
